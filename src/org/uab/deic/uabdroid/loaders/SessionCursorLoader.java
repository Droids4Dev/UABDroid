 ...
 *
 */
public class SessionCursorLoader extends DatabaseCursorLoader
{	
	private long mID;
	
	public SessionCursorLoader(Context _context, long _id) 
	{
	...
	{
		mCursor = getDatabaseAdapter().fetchSession(mID);
