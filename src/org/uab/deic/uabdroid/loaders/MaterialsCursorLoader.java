 ...
 *
 */
public class MaterialsCursorLoader extends DatabaseCursorLoader
{	
	private long mID;
	
	public MaterialsCursorLoader(Context _context, long _id) 
	{
		super(_context, DatabaseAdapter.UPDATE_MATERIALS);
		mID = _id;
	}
	...
	protected Cursor placeQuery() 
	{
		...
		{
			mCursor = databaseAdapter.fetchMaterialsBySession(mID);
